...
public class AlterarNoticia extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(noticiaService.alterar(noticia)) {
			saida.println("NOTICIA ALTERADA COM SUCESSO! <br>");
			saida.println("<a href='ListarNoticias.do'>RETORNAR INICIO</a>");
		}
		else {
			saida.println("<script>alert('DADOS PREENCHIDOS INCORRETAMENTE!')</script>");
			request.setAttribute("noticia", noticia);
